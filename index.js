...
*/
console.log('task 1 b', createMenuItem('Hamburger', 5, 'Lunch'));
console.log('task 1 b', createMenuItem('Cheeseburger', 6, 'Lunch'));
console.log('task 1 b', createMenuItem('HotDog', 4, 'Lunch'));
